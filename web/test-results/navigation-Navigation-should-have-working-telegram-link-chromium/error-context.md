...
- Name: navigation.spec.ts >> Navigation >> should have working telegram link
...
Locator: locator('a[href="https://t.me/arsstomat"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href="https://t.me/arsstomat"]').first()
