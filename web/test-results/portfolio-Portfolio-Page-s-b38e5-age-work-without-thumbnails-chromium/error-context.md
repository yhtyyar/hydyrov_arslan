...
- Name: portfolio.spec.ts >> Portfolio Page >> should display single image work without thumbnails
- Location: e2e\portfolio.spec.ts:99:7
...
Call log:
  - waiting for locator('button.group').filter({ hasText: 'Циркониевые коронки' })
