...
- Name: portfolio.spec.ts >> Portfolio Page >> should have responsive portfolio grid
- Location: e2e\portfolio.spec.ts:117:7
...
Locator: locator('button.group').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button.group').first()
