...
- Name: portfolio.spec.ts >> Portfolio Page >> should have contact CTA section
- Location: e2e\portfolio.spec.ts:111:7
...
Locator: getByText('Хотите такой же результат?')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Хотите такой же результат?')
