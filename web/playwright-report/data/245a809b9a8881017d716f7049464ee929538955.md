...
- Name: portfolio.spec.ts >> Portfolio Page >> should display all work categories
- Location: e2e\portfolio.spec.ts:17:7
...
Call log:
  ...
  - waiting for getByText('Хирургия')
